...
export default function Hero() {
  ...
  return (
    <section id="accueil" className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-red-700 text-white pt-24 pb-20 overflow-hidden">
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 transform -translate-y-1/2 z-20 bg-white/20 hover:bg-white/30 backdrop-blur-sm p-3 rounded-full transition-all duration-300 min-w-[44px] min-h-[44px] hidden md:flex items-center justify-center"
